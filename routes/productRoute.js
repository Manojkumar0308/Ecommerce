...
const { createProduct, getProduct, getAllProducts, updateProduct, deleteProduct, addToWishlist, rating, uploadProductImages,  } = require('../controller/productController');
...
route.put('/uploadImages/:id',authMiddleware,isAdmin,uploadPhoto.array("images",10),productImgResize,uploadProductImages);
